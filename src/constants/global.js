...
export const MANAGE_TABLE_CACHE_NUM = 25
export const STATE_RECORD_INIT = "SUBJECTRECORD_INIT"
export const STATE_RECORD_FINISHED = "SUBJECTRECORD_FINISHED"
export const STATE_RECORD_APPROVED = "SUBJECTRECORD_APPROVED"
export const STATE_RECORD_TIMEOUT = "SUBJECTRECORD_TIMEOUT"
export const STATE_RECORD_RETURNED = "SUBJECTRECORD_RETURNED"
...
export const NAV_MENU_OPTION_NEW_STUDY = {
  value: "发布实验",
  iconClass: "",
  isWithIcon: false,
  routerName: ROUTER_NAME_NEW_STUDY,
}

export const NAV_MENU_OPTION_RUNNING = {
  value: "正在进行",
  iconClass: "",
  isWithIcon: false,
  routerName: ROUTER_NAME_NEW_RUNNING,
}